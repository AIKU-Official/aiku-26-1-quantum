# 실험 ③ 워커: higher-order(3-way) cross 데이터에 Bell-0 baseline 학습.
...
hdir = circuits.cache_subdir("ho", a.method)  # cry=cache/ho, cond=cache/cond/ho
np.savez(os.path.join(hdir, f"R{a.R}_seed{a.seed}.npz"),
